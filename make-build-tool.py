...
for root, dirs, filenames in os.walk( addonsdir + "/parsers" ):
  for filename in filenames:
    sys.stdout.flush()
    sys.stderr.flush()
...
manifestText = manifestText[:len( manifestText ) - 3 ]  + '\n  ],\n  "players": [\n'
for root, dirs, filenames in os.walk( addonsdir + "/players" ):
  for filename in filenames:
    sys.stdout.flush()
    sys.stderr.flush()
...
manifestText = manifestText[:len( manifestText ) - 3 ]  + '\n  ],\n  "modules": [\n'
for root, dirs, filenames in os.walk( addonsdir + "/modules" ):
  for filename in filenames:
    sys.stdout.flush()
    sys.stderr.flush()
...
manifestText = manifestText[:len( manifestText ) - 3 ]  + '\n  ], \n  "effects": [\n'
for root, dirs, filenames in os.walk( addonsdir + "/effects" ):
  for filename in filenames:
    sys.stdout.flush()
    sys.stderr.flush()
